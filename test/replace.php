...
require_once("../drivers/MySQL/Replace.php");
require_once("../drivers/MySQL/ReplaceSelect.php");
require_once("../drivers/MySQL/ReplaceSet.php");

$statement = new Lucinda\Query\Replace("asd");
...
$statement = new Lucinda\Query\ReplaceSelect("asd");
$statement->columns(["a","s","d"]);
$statement->select($subselect);
test($statement->toString(), "REPLACE INTO asd (a, s, d)\r\nSELECT\r\nk, l, 12\r\nFROM fff");

$statement = new Lucinda\Query\ReplaceSet("asd");
