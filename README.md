...
| joinLeft    | string\|Select\|SelectGroup $tableDefinition, string $tableAlias = ""                                                                                                       | [Lucinda\Query\Clause\Join](https://github.com/aherne/php-sql-statements-api/blob/v2.0/src/Clause/Join.php)           | Adds a LEFT JOIN statement                                           |
| joinRight   | string\|Select\|SelectGroup $tableDefinition, string $tableAlias = ""                                                                                                       | [Lucinda\Query\Clause\Join](https://github.com/aherne/php-sql-statements-api/blob/v2.0/src/Clause/Join.php)           | Adds a RIGHT JOIN statement                                          |
| joinInner   | string\|Select\|SelectGroup $tableDefinition, string $tableAlias = ""                                                                                                       | [Lucinda\Query\Clause\Join](https://github.com/aherne/php-sql-statements-api/blob/v2.0/src/Clause/Join.php)           | Adds a INNER JOIN statement                                          |
| joinCross   | string\|Select\|SelectGroup $tableDefinition, string $tableAlias = ""                                                                                                       | [Lucinda\Query\Clause\Join](https://github.com/aherne/php-sql-statements-api/blob/v2.0/src/Clause/Join.php)           | Adds a CROSS JOIN statement                                          |
...
[Lucinda\Query\Vendor\MySQL\ReplaceSet](https://github.com/aherne/php-sql-statements-api/blob/v2.0/drivers/MySQL/ReplaceSet.php) encapsulates a MySQL REPLACE INTO SET statement via following public methods:
